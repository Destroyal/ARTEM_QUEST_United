...
public class SwitchScenes : MonoBehaviour
{
    ...
    public void ARTEM_To_Mines()
    {
       // SceneManager.LoadScene("Mines");
    }

    public void Mines_To_ARTEM()
    {
        // SceneManager.LoadScene("FullARTEM");
    }

    public void ARTEM_To_ICN()
    {
      //  SceneManager.LoadScene("ICN");
    }

    public void ICN_To_ARTEM()
    {
        // SceneManager.LoadScene("FullARTEM");
    }

    public void ARTEM_To_ENSAD()
    {
       // SceneManager.LoadScene("ENSAD");
    }

    public void ENSAD_To_ARTEM()
    {
        // SceneManager.LoadScene("FullARTEM");
    }
